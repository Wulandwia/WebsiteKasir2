...
?>
<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" style="background: rgb(249,245,245);
background: linear-gradient(0deg, rgba(249,245,245,1) 12%, rgba(32,250,39,1) 100%);" id="accordionSidebar">

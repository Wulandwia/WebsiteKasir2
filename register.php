...
<body class="" style="background: rgb(209,254,253);
background: linear-gradient(0deg, rgba(209,254,253,1) 0%, rgba(27,252,245,1) 100%);">
    <div class="container">
                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="h4 text-gray-900 mb-4"><b>Login Register</b></h4>
                            </div>
